...
## Description
This applyai vision plugin searches for circular objects in an image.

## Variables
- Minimum radius of object of interrest in pixels
- Maximum radius of object of interrest in pixels
