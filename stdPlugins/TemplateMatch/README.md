...
## Description
This applyai vision plugin uses a reference area of interest to look for matching areas in a picture.

## Variables
- Rectangle or reference image

## Returns
- modified image with found matches
